...
public class donumerical extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_donumerical);
    ...
    public void onnext(View view) {
        ...
        if (ans.getText().toString().equals(ser.all.quizes.get(serialization.quiznum).quest.get(serialization.totalq).optionA)) {
